...
4. Ler também `AII_Z_SYSTEM_PROMPT_REVISTO.md` (mesma pasta) para o perfil do investidor e o contexto geral do projeto — ver nota em `CLAUDE.md` sobre isto ser sempre necessário no Code, mesmo quando a rotina diz que a "ativação direta" dispensa este passo.
